...
rospy.wait_for_service('/rls_control_services/movo/pnp')
pnp_client = rospy.ServiceProxy('/rls_control_services/movo/pnp', PickPlace)
...
object.primitive_pose.position.x = 0.8
object.primitive_pose.position.y = -0.1
object.primitive_pose.position.z = 0.95
...
req.target_pose.pose.position.x = 0.8
req.target_pose.pose.position.y = -0.1
req.target_pose.pose.position.z = 0.95
